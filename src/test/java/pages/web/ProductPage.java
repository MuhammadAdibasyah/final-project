...
//    }
    ...
    public void userSeeAll() throws InterruptedException {
        Assert.assertTrue(driver.findElement(phoneProduct).isDisplayed());
        Thread.sleep(1500);
        Assert.assertTrue(driver.findElement(laptopProduct).isDisplayed());
        Thread.sleep(1500);
        Assert.assertTrue(driver.findElement(monitorProduct).isDisplayed());
        Thread.sleep(1500);
    }

    public void userSee(String monitors) {
    }
